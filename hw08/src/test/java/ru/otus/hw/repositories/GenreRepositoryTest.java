...
class GenreRepositoryTest {
    ...
    void setUp() {
        ...
        var genresToSave = IntStream.range(1, 7).boxed()
                .map(id -> new Genre(null, "Genre_" + id))
                .toList();

        dbGenres = repository.saveAll(genresToSave);
    }
    ...
    void shouldReturnEmptyListForNonExistingIds() {
        var actualGenres = repository.findAllById(Set.of("000000000000000000000000", "000000000000000000000001"));
